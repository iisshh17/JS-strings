...
var proverb = 'If you fail, never give up because FAIL means "First Attempt In Learning"';
console.log(proverb);

// Challenge 3: Store a string in a variable and display the length of the string.
var mood = "Ohkish mood";
...
console.log(love.replace(/programming/g, "JavaScript programming"));
...
var lesson = "Time and Tide wait for none";
console.log(lesson.indexOf("Ti"));
...
console.log(change.slice(16,22));
console.log(change.substring(46,51));
